...
def example_jsonl_data():
    return [
        {"event": {"device": "MD=CISCO_EPNM!ND=DeviceA", "info": "Some info"}},
        {
            "event": {
        ...
        {"event": {"device": "MD=CISCO_EPNM!ND=DeviceC", "info": "More info"}},
        {"event": {"device": "DeviceD", "info": "Different format"}},
    ]
...
def example_mangled_data():
    return [
        ...
        {"event": {"device": "DEVICE-004", "info": "Different format"}},
    ]
